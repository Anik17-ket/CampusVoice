...
- Passwords are now hashed with `bcrypt` on registration and compared on login; the default salt rounds is 10 but can be overridden with `SALT_ROUNDS` environment variable.
